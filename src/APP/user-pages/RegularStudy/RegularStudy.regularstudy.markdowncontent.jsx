...
import * as itemS from './Styled/RegularStudy.regularstudy.markdowncontent.styles';
...
export default function MarkdownContent({ markdownContent }) {
  ...
  return (
    <itemS.MarkdownContentContainer dangerouslySetInnerHTML={renderPreview()} />
  );
}
