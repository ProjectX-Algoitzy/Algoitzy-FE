            ...
            <ContentWrapper>
                <Routes>
                    ...
                    <Route
                        ...
                        element={isLoggedIn() ? <WritingApplication /> : <Navigate to="/" />}
                    />
                    ...
                    <Route
                        path="/editstudy/:id"
                        element={isLoggedIn() ? <MakingSelfStudyEditStudy /> : <Navigate to="/" />}
                    />
                    ...
                    <Route path="/writepost" element={isLoggedIn() ? <WritePost /> : <Navigate to="/" />} />{' '}
                    {/* 새 글쓰기 */}
