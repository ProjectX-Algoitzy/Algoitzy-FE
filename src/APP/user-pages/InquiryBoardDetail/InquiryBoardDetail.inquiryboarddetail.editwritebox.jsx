...
import * as itemS from './Styled/InquiryBoardDetail.inquiryboarddetail.editwritebox.styles';
import {AlertContext} from '../../Common/Alert/AlertContext';

export default function InquiryEditWritebox({
    replyId,
    fetchComment,
    handleLoad,
    editContent = '',
    ...
    const handleEdit = async () => {
        ...
        try {
            const response = await request.patch(`/inquiry-reply/${replyId}`, requestBody);
        ...
        <itemS.Container>
            <itemS.WriteBox iscomment={isComment}>
                ...
                <itemS.ButtonBox iscomment={isComment}>
                    ...
                    <itemS.SubmitBtn onClick={handleEdit} isActive={comment.length > 0 && comment.length}>
                        올리기
                    </itemS.SubmitBtn>
                </itemS.ButtonBox>
            </itemS.WriteBox>
