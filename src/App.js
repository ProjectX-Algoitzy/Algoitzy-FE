    ...
    <Root>
      ...
      <ContentWrapper>
        <Routes>
          ...
          <Route
            path="/writingapplication/:type/:id"
            element={
              isLoggedIn() ? <WritingApplication /> : <Navigate to="/" />
            }
          />
          <Route
            path="/studylist"
            element={isLoggedIn() ? <StudyList /> : <Navigate to="/" />}
          />
          ...
          <Route
            path="/study"
            element={
              isLoggedIn() ? <MakedSelfStudyList /> : <Navigate to="/" />
            }
          />
          <Route
            path="/newstudy"
            element={isLoggedIn() ? <MakingSelfStudy /> : <Navigate to="/" />}
          />
          <Route
            path="/editstudy/:id"
            element={
              isLoggedIn() ? <MakingSelfStudyEditStudy /> : <Navigate to="/" />
            }
          />
          <Route
            path="/study/:id"
            element={isLoggedIn() ? <SelftStudyMain /> : <Navigate to="/" />}
          />
          <Route
            path="/regularstudy/:id"
            element={isLoggedIn() ? <RegularStudy /> : <Navigate to="/" />}
          />
          <Route
            path="/curriculumcheck/:curriculumId"
            element={isLoggedIn() ? <CurriculumCheck /> : <Navigate to="/" />}
          />
          <Route
            path="/mystudy"
            element={isLoggedIn() ? <MyStudyList /> : <Navigate to="/" />}
          />
          <Route
            path="/apply"
            element={isLoggedIn() ? <ApplyRegularStudy /> : <Navigate to="/" />}
          />
          <Route
            path="/enterbootlist"
            element={isLoggedIn() ? <EnterBootList /> : <Navigate to="/" />}
          />
          <Route
            path="/institutiondetail/:institutionId"
            element={isLoggedIn() ? <InstitutionDetail /> : <Navigate to="/" />}
          />{" "}
          {/* 기업/부트캠프 상세조회 */}
          <Route path="/mypage/:handle" element={<MyPage />} />{" "}
          {/* 마이페이지 */}
          <Route path="/myinfo" element={<EditMyInfo />} />{" "}
          {/* 개인정보 수정 */}
          <Route
            path="/writepost"
            element={isLoggedIn() ? <WritePost /> : <Navigate to="/" />}
          />{" "}
          {/* 새 글쓰기 */}
          <Route path="/community" element={<Community />} />
          <Route
            path="/inquiry"
            element={isLoggedIn() ? <Inquiry /> : <Navigate to="/" />}
          />
          <Route
            path="/board/:id"
          ...
          <Route
            path="/writeselfstudy"
            element={isLoggedIn() ? <WriteSelfStudy /> : <Navigate to="/" />}
          />{" "}
          {/* 자율스터디 생성 */}
          <Route
            path="/inquiryboard/:id"
            element={
              isLoggedIn() ? <InquiryBoardDetail /> : <Navigate to="/" />
            }
          />{" "}
          {/*문의하기 글 세부 */}
          <Route
            path="/writeinquiry"
            element={isLoggedIn() ? <WriteInquiry /> : <Navigate to="/" />}
          />{" "}
          {/* 새 문의하기 글쓰기 */}
          {/* 새 문의하기 글쓰기 */}
